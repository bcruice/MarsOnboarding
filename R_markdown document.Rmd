...
```
#### Plotting MARS Data
Below are the plots for draw down for `r smpId` during the three largest events, by total precipitation depth, measured between the dates `r format(start_date,"%D")` and `r format(end_date, "%D")`.

```{r echo = FALSE, message = 'hide', warning = FALSE}

rain_event_data %>% dplyr::arrange()
